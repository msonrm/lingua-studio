...
it('Phase 2-F 再採点: 意図した読みに言及したか', () => {
  const phase2: Phase2Result[] = JSON.parse(readFileSync('experiments/out/phase2f-instructed.json', 'utf-8'));
  ...
  writeFileSync('experiments/out/phase2f-instructed-judged.json', JSON.stringify(results, null, 1));
  ...
  writeFileSync(
    'experiments/out/phase2f-instructed-judged-summary.json',
    JSON.stringify(
      {
